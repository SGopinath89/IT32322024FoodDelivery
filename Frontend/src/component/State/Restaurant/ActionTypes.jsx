...
export const UPDATE_RESTAURANT_STATUS_REQUEST = "UPDATE_RESTURANT_STATUS_REQUEST";
export const UPDATE_RESTAURANT_STATUS_SUCCESS = "UPDATE_RESTURANT_STATUS_SUCCESS";
export const UPDATE_RESTAURANT_STATUS_FAILURE = "UPDATE_RESTURANT_STATUS_FAILURE";
